...
let s:colors = {
      ...
      \ "comment_grey": get(s:overrides, "comment_grey", { "gui": "#697098", "cterm": "246", "cterm16": "15" }),
      \ "bak_comment_grey": get(s:overrides, "bakcomment_grey", { "gui": "#697098", "cterm": "59", "cterm16": "15" }),
      \ "gutter_fg_grey": get(s:overrides, "gutter_fg_grey", { "gui": "#4B5263", "cterm": "243", "cterm16": "15" }),
      \ "bak_gutter_fg_grey": get(s:overrides, "gutter_fg_grey", { "gui": "#4B5263", "cterm": "238", "cterm16": "15" }),
